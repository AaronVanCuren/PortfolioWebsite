$(document).ready(function(){
	...
	$("#threePrinciples div").on("mouseenter", function(){
	...
	$("#threePrinciples div").on("mouseleave", function(){
	...
	var highlight5Waypoint = new Waypoint({
		element: document.getElementById("highlightsSection"),
		handler: function(direction) {
			if(direction === "down" && highlight5TriggeredYet === 0) {
				$("#highlight5").delay(5000).show("slide", { direction: "left" }, 1000);
				highlight5TriggeredYet = 1;
			}
		},
		offset: "75%"
	});
